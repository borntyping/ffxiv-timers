<!--
Example from https://svelte.dev/examples/clock
Source: https://github.com/sveltejs/svelte/tree/master/documentation/examples/12-svg/01-clock
License: MIT License (https://github.com/sveltejs/svelte/blob/master/LICENSE.md)
-->
<script>
